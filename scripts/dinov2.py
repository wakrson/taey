...
class DINOBackbone(Engine):
    ...
    def build_tensorrt(self, model_path: Path) -> None:
        ...
        #profile.set_shape('input', min=(1, 3, 280, 280), opt=(4, 3, 280, 280), max=(8, 3, 280, 280))
        super().build_tensorrt(model_path, builder, network, parser)

def main():
    dino = DINOBackbone('models/dinov2_vitl14_reg.onnx')
