...
class SigLIP2(Engine):
    ...
    def build_tensorrt(self, model_path: Path) -> None:
        ...
        profile.set_shape("input", min=(1, 3, 256, 256), opt=(1, 3, 256, 256), max=(16, 3, 256, 256))
...
def main():
    ...
    model = SigLIP2(f'{rootdir}/models/siglip2/siglip2_base_patch32_256.onnx')
